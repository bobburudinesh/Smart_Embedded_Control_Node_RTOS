...
clean-Tasks-2f-Src:
	-$(RM) ./Tasks/Src/Activity_Monitor_Task.cyclo ./Tasks/Src/Activity_Monitor_Task.d ./Tasks/Src/Activity_Monitor_Task.o ./Tasks/Src/Activity_Monitor_Task.su ./Tasks/Src/crypto_task.cyclo ./Tasks/Src/crypto_task.d ./Tasks/Src/crypto_task.o ./Tasks/Src/crypto_task.su ./Tasks/Src/logger_task.cyclo ./Tasks/Src/logger_task.d ./Tasks/Src/logger_task.o ./Tasks/Src/logger_task.su ./Tasks/Src/modem_task.cyclo ./Tasks/Src/modem_task.d ./Tasks/Src/modem_task.o ./Tasks/Src/modem_task.su ./Tasks/Src/oled_display_task.cyclo ./Tasks/Src/oled_display_task.d ./Tasks/Src/oled_display_task.o ./Tasks/Src/oled_display_task.su ./Tasks/Src/sensor_task.cyclo ./Tasks/Src/sensor_task.d ./Tasks/Src/sensor_task.o ./Tasks/Src/sensor_task.su
